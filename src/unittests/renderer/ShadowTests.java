...
public class ShadowTests {
	...
	public void SphereTriangleInitial() {
		...
		scene.addLights(new SpotLight(new Color(400, 240, 0),new Point3D(-100, 100, -200), 2, 1E-5, 1.5E-7, new Vector(1, -1, 3)));
	...
	public void SphereTriangleMove1() {
		...
		scene.addLights(new SpotLight(new Color(400, 240, 0), //
				new Point3D(-100, 100, -200), 2, 1E-5, 1.5E-7, new Vector(1, -1, 3)));
	...
	public void SphereTriangleSpot1() {
		...
		scene.addLights(new SpotLight(new Color(400, 240, 0), //
				new Point3D(-90, 90, -140), 2, 1E-5, 1.5E-7, new Vector(1, -1, 3)));
	...
	public void SphereTriangleSpot2() {
		...
		scene.addLights(new SpotLight(new Color(400, 240, 0), //
				new Point3D(-80, 80, -120),2, 1E-5, 1.5E-7, new Vector(1, -1, 3)));
	...
	public void trianglesSphere() {
		...
		scene.addLights(new SpotLight(new Color(700, 400, 400), //
				new Point3D(40, -40, -115), 2, 4E-4, 2E-5, new Vector(-1, 1, 4)));
